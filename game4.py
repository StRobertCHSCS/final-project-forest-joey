...
def menu():
    ...
    if intro and instructions_number == 0:
        ...
        arcade.draw_text(text_instru, 210, 210, arcade.color.WHITE, 24, font_name='Comic Sans MS')
...
def text_panel_1():
    arcade.draw_rectangle_filled(220, 210, 270, 70, arcade.color.ORANGE)
...
def on_key_press(key, modifiers):
    ...
    """
    global right_pressed, left_pressed, intro, instructions_number, player_x, player_y, jump_h, shift
